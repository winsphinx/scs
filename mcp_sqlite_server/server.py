...
class ServerWrapper:
    ...
    def call_tool(self, name: str, arguments: dict) -> dict:
        ...
        try:
            if name == "create_table":
                ...
                # Execute the create table query directly
                with closing(sqlite3.connect(self.db_path)) as conn:
                    cursor = conn.cursor()
            ...
            return {"error": f"Tool {name} not implemented in wrapper"}
        except sqlite3.Error as e:
    ...
    def run(self):
        ...
        asyncio.run(main(self.db_path))


# Create wrapper instance without initializing server immediately
